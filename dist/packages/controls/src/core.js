import { AvaloniaObject, Animatable, AvaloniaProperty, DefineProperties, BindingPriority, Event, Disposable, CompositeDisposable, Classes, AvaloniaList, Size, Rect, Point, Matrix, Thickness, CornerRadius, RelativePoint, MathUtilities } from '@wieslawsoltes/avalonia-base';
import { Brush, Brushes, Pen, Typeface, TextLayout, TextLayoutCache, Effect, IEffect, TransformOperations } from '@wieslawsoltes/avalonia-media';
import { ResourceDictionary, Styles, Styler, ThemeVariant, ResourceEnvironment, FindResource, TryFindResource } from '@wieslawsoltes/avalonia-styling';
let visualId = 0;
