...
import { Brush, SolidColorBrush, Color, Colors, Bitmap, IEffect, EffectExtensions } from "../../media/src/index.js";
...
export class Compositor extends Disposable {
    ...
    async CreateCompositionVisualSnapshot(visual,scaling=1) {
        ...
        const {SkiaDrawingContext}=await import("../../skia/src/index.js");
