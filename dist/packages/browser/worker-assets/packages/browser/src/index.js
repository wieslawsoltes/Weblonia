...
import { TextServicesChanged } from "../../media/src/index.js";
import { DefineProperties, Size, Rect, Point, Event, Disposable, CompositeDisposable, NotSupportedException, AvaloniaList } from "../../base/src/index.js";
import { ResourceDictionary, Styles, ThemeVariant, ResourceEnvironment } from "../../styling/src/index.js";
import { ContentControl, Control, Canvas, FocusManager, LayoutManager, InputElement, TextBox, Pointer, PointerEventArgs, PointerPressedEventArgs, PointerReleasedEventArgs, PointerWheelEventArgs, KeyEventArgs, RoutedEventArgs, ModifiersFromDom, Palettes, NameScope, ToggleButton, Slider, Button, AutomationProperties, GetAutomationAriaProperties, TextBoxAutomationPeer, TextBlockAutomationPeer, TableViewColumnHeaderAutomationPeer } from "../../controls/src/index.js";
import { PreviousTextPosition, NextTextPosition } from "../../media/src/index.js";
import { SkiaPlatform, SkiaRenderer } from "../../skia/src/index.js";
...
export class AppBuilder {
    ...
    async StartBrowserAppAsync(elementOrId, options = {}) {
        ...
        if (config.ReactiveUI)
            (await import("../../reactiveui/src/index.js")).UseReactiveUI();
