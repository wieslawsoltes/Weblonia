import { Event, Disposable, Point, Vector, Size, Rect, Matrix } from "../../base/src/index.js";
...
import { CompositionExpression, ScalarKeyFrameAnimation, Vector2KeyFrameAnimation, Vector3KeyFrameAnimation, ColorKeyFrameAnimation, ExpressionAnimation } from "../../composition/src/index.js";
import * as Easings from "../../animation/src/index.js";
        ...
        try {
            ...
            for (const [id, resource] of resources) {
                ...
                if (resource.Kind === 'Image' && resource.Data.Url) {
                    const { Bitmap } = await import("../../media/src/index.js"); const bitmap = new Bitmap(resource.Data.Url);
