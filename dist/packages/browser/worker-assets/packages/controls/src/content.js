...
import { DefineProperties, Size, Rect, Point, Matrix, Thickness, MathUtilities, BindingPriority, Disposable, Event, AvaloniaProperty } from "../../base/src/index.js";
import { TextLayout, Pen, Brushes, Geometry, StreamGeometry, RectangleGeometry, EllipseGeometry, LineGeometry, DrawingImage, Bitmap, Typeface, TransformOperations, GetTextServiceVersion } from "../../media/src/index.js";
